...
julia --compiled-modules=no cluster_optics.jl $SLURM_ARRAY_TASK_ID $FOLDER $SLURM_ARRAY_JOB_ID $GROUNDSTATE

#run as: sbatch run_optics_reshuffled_PRB.sh folderid gs